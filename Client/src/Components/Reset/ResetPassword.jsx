  ...
  return (
    ...
    <div className="w-full md:max-w-lg max-w-sm  bg-gray-800 rounded-lg shadow-md md:p-6 p-4 m-4">
      ...
      <form className="flex flex-col">
        ...
        />
        <span className={`${!beforeApicall?'hidden':isverified?"text-green-500 block":!isverified?"text-red-600 block":"hidden"} pl-4`}> {isverified?"We send you a Reset Link check your Email": !isverified?"Not a Valid User":''}</span>
        </div>
        <button
